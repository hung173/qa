...
INSERT INTO public.users (guid,username,"password",first_name,last_name,email,user_type,status,is_active,created_by,created_date,last_modified_by,last_modified_date) VALUES
    ('23b9d3c4-ace0-4279-9529-14c6eb3db154','admin','$2a$12$IXGFMoGXC6v4BVSllNH3Z.9hE.24K5K2k70XQt7HOK0/HEjI.Eo8.','admin','admin','admin@admin.com','LOCAL','ACTIVE',true,'admin',NULL,NULL,NULL);
